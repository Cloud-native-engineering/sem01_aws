...
Amazon Web Services, auch AWS genannt, ist eine der führenden Cloud-Plattformen. Die Möglichkeiten sind nahezu unbegrenzt. Damit man diese wichtige Technologie verwenden kann, benötigt man vertiefte Kenntnisse über die Stärken und Schwächen von AWS. Der Lernprozess zum optimalen Umgang von AWS benötigt Zeit und Erfahrung. Um den Wissensstand vorweisen zu können, bietet Amazon verschiedene Zertifizierungen an. Im Rahmen dieser Semesterarbeit will ich mich bestmöglich für die «AWS Certified Cloud Practitioner» Zertifizierung vorbereiten und meinen Lernprozess dokumentieren. Dies erreiche ich mithilfe von Zusammenfassungen und der Umsetzung von eigenen Hands-on-Projekte.
...
[3. Learningpath](docs/03_Learningpath/index.md)

[3.1 What's a Cloud](docs/03_Learningpath/whats_a_cloud.md)

[3.2 What's AWS?](docs/03_Learningpath/whats_aws.md)

[3.3 Globale AWS-Infrastruktur](docs/03_Learningpath/aws_global_infrastructure.md)

[3.4 AWS Services](docs/03_Learningpath/aws_services.md)

[3.5 Benefits of the cloud](docs/03_Learningpath/benefits_cloud.md)

[3.6 Shared Responsibility Model](docs/03_Learningpath/aws_shared_responsibility.md)

[3.7 Kosten der Cloud](docs/03_Learningpath/pricing.md)

[3.8 Identity and Access Management](docs/03_Learningpath/aws_iam.md)

[3.9 Elastic Compute 2](docs/03_Learningpath/aws_ec2.md)

[3.10 Storage @ AWS](docs/03_Learningpath/aws_storage.md)

[3.11 Database @ AWS](docs/03_Learningpath/database.md)

[4. Zertifizierungsfragen](docs/04_Zertifizierungsfragen/index.md)

[4.1 AWS Academy Cloud Foundation](docs/04_Zertifizierungsfragen/aws_cloud_foundation/index.md)

[4.2 Udemy Ultimate AWS Certified Cloud Practitioner](docs/04_Zertifizierungsfragen/udemy/index.md)

[4.3 AWS Skillbuilder](docs/04_Zertifizierungsfragen/aws_skillbuilder.md)

[5. Hands-on-Projekte](docs/05_Hands-on-Projekte/index.md)

[5.1 Offsite Backup](docs/05_Hands-on-Projekte/offsite_backup.md)

[5.2 Host Website on S3](docs/05_Hands-on-Projekte/s3_website.md)
